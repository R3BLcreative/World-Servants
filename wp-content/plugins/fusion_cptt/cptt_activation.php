...
function cptt_avada_cpt_activation()
{
...
function cptt_admin_notice_run()
{
    if (get_transient('cptt-admin-notice-show')) {
        ...
        <div class="notice notice-warning is-dismissible">
            <p>Add the new Fusion Builder elements in Fusion Builder->Settings ->Fusion Builder Elements (<strong>Blog
...
register_activation_hook(plugin_dir_path(__FILE__) . 'fusion_cptt.php', 'cptt_avada_cpt_activation');
?>