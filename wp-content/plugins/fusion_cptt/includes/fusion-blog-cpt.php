    ...
    class FusionSC_Blog_CPT extends Fusion_Element
    {
...

        {
            ...
            if ('grid' === $this->args['layout'] || 'masonry' === $this->args['layout'] || 'timeline' === $this->args['layout']) {
                ...
                $pre_title_content .= '<div ' . FusionBuilder::attributes('blog_cpt-shortcode-post-content-wrapper') . '>';
            }
    ...
    fusion_builder_map(array(
        ...
        'params' => array(
            ...
            array(
                ...
                'default' => 'date',
                'value' => array(
                    'meta_value' => esc_attr__('Custom Field as Text', 'fusion-builder'),
                    'meta_value_num' => esc_attr__('Custom Field as Numbers', 'fusion-builder'),
            ...
            array(
                'type' => 'select',
                'heading' => esc_attr__('Custom Field to Order By', 'fusion-builder'),
                'description' => esc_attr__('Defines by which Custom Field to order.', 'fusion-builder'),
                'param_name' => 'sorting_key',
                'default' => 'select_cfield',
                'value' => $am_custom_fields,
                'dependency' => array(
                    array(
